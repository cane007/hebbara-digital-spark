...
export default function Process() {
  ...
  return (
    <section ref={sectionRef} id="process" className="section-padding bg-gradient-to-b from-background via-muted/20 to-background relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, index) => (
            <Card key={index} className="process-card fade-in-up relative overflow-hidden group hover-float border-2 border-transparent hover:border-primary/30 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500">
              <CardContent className="p-6 relative">
                ...
                <div className="absolute -top-6 -right-6 text-8xl font-bold text-primary/5 group-hover:text-primary/15 transition-all duration-300 group-hover:scale-110">
                  {step.step}
                </div>
        ...
        <div className="text-center mt-16 animate-fade-in-up">
          <div className="inline-block p-8 bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/10 rounded-2xl border border-primary/20 hover:border-primary/40 transition-all hover:scale-105 hover-glow">
            ...
            <a 
              href="#contact" 
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary via-accent to-secondary text-white font-bold text-lg rounded-xl hover:scale-110 transition-all shadow-lg hover:shadow-2xl"
            >
