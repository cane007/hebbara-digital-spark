...
export default function Process() {
  ...
  return (
    <section ref={sectionRef} id="process" className="section-padding bg-gradient-to-b from-background to-secondary/20">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {/* Connection Lines */}
          <div className="hidden lg:block absolute top-1/4 left-0 right-0 h-0.5 bg-gradient-to-r from-primary via-accent to-primary opacity-20"></div>
          
          {steps.map((step, index) => (
            <Card key={index} className="process-card fade-in-up card-clean relative overflow-hidden group">
              <CardContent className="p-6">
                ...
                {/* Icon */}
                <div className={`w-16 h-16 bg-${step.color}/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform relative z-10`}>
